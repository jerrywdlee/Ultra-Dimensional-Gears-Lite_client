...
var set_sensor_table = "CREATE TABLE instrument_table (id INTEGER PRIMARY KEY AUTOINCREMENT,instr_name TEXT NOT NULL,mac_addr TEXT,config TEXT NOT NULL);";
var set_data_table = " CREATE TABLE data_table( instr_name TEXT NOT NULL,mac_addr TEXT,sample_time DATETIME PRIMARY KEY,raw_data NUMERIC,config TEXT NOT NULL,pushed INT NOT NULL); ";
//wait until DB ready
var wait_time = 2500;
