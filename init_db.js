...
var set_data_table = " CREATE TABLE data_table( instr_name TEXT UNIQUE NOT NULL,mac_addr TEXT,sample_time DATETIME PRIMARY KEY,raw_data NUMERIC,config TEXT NOT NULL,pushed INT NOT NULL); ";
//wait until DB ready
var wait_time = 2500;
